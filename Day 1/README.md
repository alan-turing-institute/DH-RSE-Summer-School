...
In the afternoon, **Kasra Hosseini, Mariona Coll Ardanuy and Federico Nanni** will present a collaborative activity focused on learning gitflow while contributing to the open source digital humanities tool DeezyMatch. For more information see the README in the [gitflow](./gitflow) folder and the [Slides](https://drive.google.com/file/d/1n8vQ9sZ3M6QDxiE24rYE7PXviTKBxOWD/view?usp=sharing).
